...
from seg.losses.criterions.utils import weight_reduce_loss
from ..registry import LOSSES
from seg.utils.typing import Optional, Union, Tuple, Tensor
...
class IoULoss(BaseLoss):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super().__init__(loss_name=f"{iou_mode}_loss", **kwargs)
    ...
    def forward(
        ...
        **kwargs) -> Tuple[Union[torch.Tensor, torch.Tensor], torch.Tensor]:
        """Forward function.
